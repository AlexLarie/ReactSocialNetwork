...
import { newTextChangActionCreator } from '../../redax/profile-reducer';
...
const Content = (props) => {
   return(
      <div className = "content">
         ...
         <Post__new__container addPost = {props.addPost.dispatch(newTextChangActionCreator)} updateNewPostText = {props.updateNewPostText} 
